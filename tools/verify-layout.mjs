...
const CASES = [
  ...
  { size: '1920x1080', query: '?fixture=2026&moment=extra', label: 'two kickers', moment: 'extraKicker' },
  { size: '1024x768', query: '?fixture=2026&moment=extra', label: 'two kickers at 4:3', moment: 'extraKicker' },
  { size: '390x844', query: '?fixture=2026&moment=extra', label: 'two kickers on a phone', moment: 'extraKicker' },
  ...
  { size: '1920x1080', query: '?fixture=2026&moment=named', label: 'named player', moment: 'namedPlayer' },
  { size: '1024x768', query: '?fixture=2026&moment=named', label: 'named player at 4:3', moment: 'namedPlayer' },
  { size: '390x844', query: '?fixture=2026&moment=named', label: 'named player on a phone', moment: 'namedPlayer' },
  { size: '1920x1080', query: '?fixture=2026&moment=broke', label: 'tapped out', moment: 'firstBroke' },
  { size: '1024x768', query: '?fixture=2026&moment=broke', label: 'tapped out at 4:3', moment: 'firstBroke' },
  { size: '390x844', query: '?fixture=2026&moment=broke', label: 'tapped out on a phone', moment: 'firstBroke' },
